...
<br>
## Description
This project implements an image encryption and decryption system using chaos maps. The primary goal is to secure images by transforming them into encrypted versions that can only be decrypted with the correct key. The system is capable of handling non-square images and offers a robust method for data security.
<br>
